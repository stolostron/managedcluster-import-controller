	...
	testcases := []struct {
	...
	}{
		{
			...
			validateFunc: func(t *testing.T, objs, crds []runtime.Object) {
				...
				testinghelpers.ValidateKlusterlet(t, objs[1], operatorv1.InstallModeDefault,
					"klusterlet", "test", constants.DefaultKlusterletNamespace)
				testinghelpers.ValidateBoostrapSecret(t, objs[4], "bootstrap-hub-kubeconfig", constants.DefaultKlusterletNamespace, "bootstrap kubeconfig")
				testinghelpers.ValidateImagePullSecret(t, objs[5], constants.DefaultKlusterletNamespace, "{}")
		...
		},
		{
			...
			validateFunc: func(t *testing.T, objs, crds []runtime.Object) {
				...
				testinghelpers.ValidateKlusterlet(t, objs[1], operatorv1.InstallModeDefault,
					"klusterlet", "test", constants.DefaultKlusterletNamespace)
				testinghelpers.ValidateBoostrapSecret(t, objs[5], "bootstrap-hub-kubeconfig",
					constants.DefaultKlusterletNamespace, "bootstrap kubeconfig")
				testinghelpers.ValidateImagePullSecret(t, objs[6], constants.DefaultKlusterletNamespace, "fake-token")
			},
		},
		{
			name: "hosted",
			...
			validateFunc: func(t *testing.T, objects, crds []runtime.Object) {
				testinghelpers.ValidateObjectCount(t, objects, 2)
				testinghelpers.ValidateCRDs(t, crds, 0)
				testinghelpers.ValidateKlusterlet(t, objects[0], operatorv1.InstallModeHosted,
		...
		},
		{
			...
			validateFunc: func(t *testing.T, objects, crds []runtime.Object) {
				...
				testinghelpers.ValidateKlusterlet(t, objects[1], operatorv1.InstallModeDefault,
					"klusterlet", "test", "open-cluster-management-agent")
				klusterlet, _ := objects[1].(*operatorv1.Klusterlet)
				...
				deployment, ok := objects[7].(*appv1.Deployment)
				if !ok {
		...
		},
		{
			...
			validateFunc: func(t *testing.T, objects, crds []runtime.Object) {
				...
				priorityClass, ok := objects[4].(*schedulingv1.PriorityClass)
				if !ok {
		...
		},
		{
			...
			validateFunc: func(t *testing.T, objs, crds []runtime.Object) {
				...
				testinghelpers.ValidateKlusterlet(t, objs[1], operatorv1.InstallModeDefault,
					"klusterlet", "test", constants.DefaultKlusterletNamespace)
				klusterlet, _ := objs[1].(*operatorv1.Klusterlet)
				...
				testinghelpers.ValidateBoostrapSecret(t, objs[4], "bootstrap-hub-kubeconfig-current-hub",
					constants.DefaultKlusterletNamespace, "bootstrap kubeconfig")
				testinghelpers.ValidateBoostrapSecret(t, objs[5], "bootstrapkubeconfig-hub1",
					constants.DefaultKlusterletNamespace, "fake-kubeconfig")
				testinghelpers.ValidateBoostrapSecret(t, objs[6], "bootstrapkubeconfig-hub2",
					constants.DefaultKlusterletNamespace, "fake-kubeconfig")
