...
type ConfigV1alpha1Interface interface {
	...
	KlusterletConfigsGetter
}

// ConfigV1alpha1Client is used to interact with features provided by the config.open-cluster-management.io group.
...
func setConfigDefaults(config *rest.Config) error {
	gv := klusterletconfigv1alpha1.SchemeGroupVersion
