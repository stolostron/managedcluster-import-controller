...
var _ = ginkgo.Describe("Importing and detaching a managed cluster with hosted mode", func() {
	...
	ginkgo.Context("Detach multiple hosted clusters", func() {
		ginkgo.It("should delete each cluster independently", func() {
			...
			assertManagedClusterImportSecretCreated(hosted1, "other", constants.KlusterletDeployModeHosted)
			...
			assertManagedClusterImportSecretCreated(hosted2, "other", constants.KlusterletDeployModeHosted)
