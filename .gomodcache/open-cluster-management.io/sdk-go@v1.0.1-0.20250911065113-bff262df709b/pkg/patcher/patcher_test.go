	...
	cases := []struct {
	...
	}{
		{
			...
			validateActions: func(t *testing.T, actions []clienttesting.Action) {
				...
				testingcommon.AssertFinalizers(t, managedCluster, []string{"test-finalizer"})
			},
		},
		{
			...
			validateActions: func(t *testing.T, actions []clienttesting.Action) {
				...
				testingcommon.AssertFinalizers(t, managedCluster, []string{"test-finalizer-1", "test-finalizer"})
			},
		},
		{
			name:            "no action",
	...
	cases := []struct {
	...
	}{
		{
			...
			validateActions: func(t *testing.T, actions []clienttesting.Action) {
				...
				testingcommon.AssertFinalizers(t, managedCluster, []string{"test-finalizer-1"})
			},
		},
		{
		...
		},
		{
			...
			validateActions: func(t *testing.T, actions []clienttesting.Action) {
				...
				testingcommon.AssertFinalizers(t, managedCluster, []string{"test-finalizer-1", "test-finalizer-2"})
			},
		},
		{
			name:            "no action",
