...
import (
	...
	action "github.com/stolostron/cluster-lifecycle-api/client/action/informers/externalversions/action"
...
func (f *sharedInformerFactory) Action() action.Interface {
	return action.New(f, f.namespace, f.tweakListOptions)
}
