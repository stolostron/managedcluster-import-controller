...
import (
	...
	view "github.com/stolostron/cluster-lifecycle-api/client/view/informers/externalversions/view"
...
func (f *sharedInformerFactory) View() view.Interface {
	return view.New(f, f.namespace, f.tweakListOptions)
}
