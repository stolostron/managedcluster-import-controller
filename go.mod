...
replace github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models 7f2c2a5519f3 // https://github.com/openshift/assisted-service/tree/release-ocm-2.9/models
