...
replace github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models 1dc66326d304 // https://github.com/openshift/assisted-service/tree/release-ocm-2.9/models
