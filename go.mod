...
replace github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models 816a96b87e9b // https://github.com/openshift/assisted-service/tree/release-ocm-2.9/models
