...
require (
	...
	github.com/openshift/hive/apis v0.0.0-20260205190451-e2f8da6a8ee6
	github.com/openshift/library-go v0.0.0-20251112091634-ab97ebb73f0f // https://github.com/openshift/library-go/tree/release-4.14
