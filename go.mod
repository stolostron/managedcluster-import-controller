...
replace github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models abd01432ec2c // https://github.com/openshift/assisted-service/tree/release-ocm-2.9/models
