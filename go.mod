...
replace (
	github.com/open-cluster-management/api => open-cluster-management.io/api v0.0.0-20201210143210-581cab55c797
	github.com/open-cluster-management/applier => github.com/stolostron/applier v0.0.0-20210422205113-6c10f923726b
	github.com/open-cluster-management/library-go => github.com/stolostron/library-go v0.0.0-20210325215722-d989f79194f6
)
