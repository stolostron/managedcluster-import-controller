...
require (
	...
	github.com/openshift/hive/apis v0.0.0-20241007160427-f278a2856208
...
replace github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models v0.0.0-20250315133418-9e4eeae5cf7f
