...
replace github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models 9e4eeae5cf7f // https://github.com/openshift/assisted-service/tree/release-ocm-2.9/models
