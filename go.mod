...
replace github.ibm.com/IBMPrivateCloud/multicloud-operators-foundation => github.com/rh-ibm-synergy/multicloud-operators-foundation v0.0.0-20200129023941-fec237add026
