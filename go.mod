...
require (
	...
	github.com/openshift/library-go v0.0.0-20260213153706-03f1709971c5 // https://github.com/openshift/library-go/tree/release-4.14
...
require (
	...
	helm.sh/helm/v3 v3.21.1 // indirect
