...
replace github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models 0889f438699f // https://github.com/openshift/assisted-service/tree/release-ocm-2.9/models
